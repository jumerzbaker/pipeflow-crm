...
- Pipeline Kanban de vendas com drag → Contato → Proposta → Negociação → Fechado Ganho/Perdido)
...
- Página de detalhe com perfil completo e timeline de Vendas
...
- Plano Free: até 2 colaboradores, 50 leads por workspace
- Plano Pro: leads ilimitados (R$49/mês)
...
- Pontos fortes: UX intuitiva, pipeline Kanban referência de mercado, foco em ação (activity-based selling)
